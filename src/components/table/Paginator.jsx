...
const Paginator = ({ page, onPageChange }) => {
  ...
  return (
    <div className="mt-4 flex flex-col items-center justify-between gap-3 border-t border-gray-200 p-4 px-4 py-3 sm:flex-row">
      ...
      <div className="flex items-center space-x-2">
        <button
          ...
          className={`flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-gray-200 ${
            isPreviousPage
        ...
        {pageNumbers.map((pageNum) => (
          <button
            ...
            className={`flex h-9 w-9 cursor-pointer items-center justify-center rounded-full text-sm font-bold ${
              pageNum === currentPage
