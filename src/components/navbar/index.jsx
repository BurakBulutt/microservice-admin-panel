...
const Navbar = ({
    ...
    const profileImageUrl = `https://api.dicebear.com/7.x/initials/svg?seed=${
        userProfile?.firstName?.charAt(0) + userProfile?.lastName?.charAt(0)
    }&padding=20&fontSize=40&backgroundColor=24388a`;
    ...
    const getBreadCrumbs = () => {
        const base = [
            { path: "/", breadcrumb: () => <span>{t("home")}</span> },
            { path: "/admin", breadcrumb: () => <span>{t("admin")}</span> },
        ];
        ...
        <nav
            ...
            <div className="ml-[6px]">
                <div className="h-6 w-full pt-1">
                    {breadCrumbs?.map(({match, breadcrumb}, index) => (
                        <Link className={"text-sm font-normal text-navy-700 hover:underline dark:text-white dark:hover:text-white"} key={match.pathname} to={match.pathname}>
                            {breadcrumb}
          ...
          <FiAlignJustify className="h-5 w-5"/>
                ...
                <Dropdown
                    ...
                    children={
                        <div
                            className="flex w-40 flex-col justify-start rounded-[20px] bg-white p-2 shadow-lg dark:bg-navy-700">
                ...
                <Dropdown
                    ...
                    children={
                        <div
                            ...
                            <div
                                className="cursor-pointer flex flex-col pt-5 pl-5"
