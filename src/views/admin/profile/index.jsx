      ...
      <div className="w-full min-h-screen flex flex-wrap gap-4">
        <div className="flex flex-col gap-4">
          <Card extra={"items-center w-full h-fit p-[16px] bg-cover"}>
            ...
            >
              <div className="absolute -bottom-12 flex h-[90px] w-[90px] items-center justify-center rounded-full border-[4px] border-white bg-pink-400 dark:!border-navy-700">
                <img
          ...
          <Card extra={"w-full h-fit p-[16px] bg-cover xl:min-w-[60vh]"}>
            ...
            <div className="flex justify-end mt-10">
              <button className="w-fit rounded-2xl bg-brand-500 px-12 py-3 text-sm font-medium text-white transition duration-200 hover:bg-brand-600 active:bg-brand-700 dark:bg-brand-400 dark:text-white dark:hover:bg-brand-300 dark:active:bg-brand-200">
                {t("profileSettings.saveChanges")}
              </button>
            </div>
          </Card>
